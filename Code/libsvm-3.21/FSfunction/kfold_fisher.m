...
%
function [save_name] = kfold_fisher(feature_label,throld,repeats,parameters,KFold,save_folder)
% clear;
% clc;
% close;
tic;
...
fidname=strcat('UM_fisher_bn_246_',char(throld),'_',num2str(repeats),'.txt');
		...
		for repeat=1:repeats
			...
			for selectIndex=1:KFold
			   %% split training and testing dataset
                ...
                %%feature select
                ranking = spider_wrapper(trainData,trainLabel,numF,lower('fisher'));
